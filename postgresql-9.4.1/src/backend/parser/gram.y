...
%type <node>	stmt schema_stmt
		...
		CreatedbStmt DeclareCursorStmt DefineStmt DeleteStmt DiscardStmt DL_AnalyzeStmt DoStmt
...
%type <str>		copy_file_name
				...
				dl_inp_str dl_col_type /* DL_ANALYZE:  added for CODD */ 
...
%type <list>	stmtblock stmtmulti
				...
				relation_expr_list dostmt_opt_list dl_name_list  /* added for CODD */ 
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	DICTIONARY DISABLE_P DISCARD DISTINCT DL_ANALYSE DL_ANALYZE DO DOCUMENT_P DOMAIN_P DOUBLE_P DROP
...
/* DL_ANALYZE - begin */		
DL_AnalyzeStmt:
			dl_analyze_keyword qualified_name dl_name_list dl_col_type dl_inp_str
				{
					VacuumStmt *n = makeNode(VacuumStmt);
					n->options = VACOPT_ANALYZE;
					n->freeze_min_age = -1;
...
dl_name_list: '(' name_list ')'						{ $$ = $2; }; /* CODD */

dl_col_type:  Sconst						        { $$ = $1; }; /* CODD */

dl_inp_str:   Sconst							{ $$ = $1; }; /* CODD */
