...
static struct config_bool ConfigureNamesBool[] =
{
	...
	/* added on Aug 1, 2014 for CODD */
	#ifdef CODD_ENABLED
	{
		{"skip_pagetest", PGC_SUSET, STATS_COLLECTOR,
			gettext_noop("Skip physical page test for CODD mode"),
			NULL
		},
		&pgstat_skip_pagetest,
		false,
		NULL, NULL, NULL
	},
	#endif
...
//	/* Added by Rajmohan in Aug 2014 to enable/disable selectivity injection */
//	{
//		{"enable_injection", PGC_USERSET, 0,
//			gettext_noop("Enable/disable Selectivity Injection"),
//			NULL
//		},
//		&enable_injection,
//		false,
...
static struct config_int ConfigureNamesInt[] =
{
	...
	/* Added by Rajmohan on 28/06/2014 */
	{
		{"spill_node",PGC_USERSET,QUERY_TUNING_COST,
			gettext_noop("Set the node for spilling directive"),
			NULL
		},
		&spill_node,
		DEFAULT_SPILL_NODE,	DEFAULT_SPILL_NODE, INT_MAX,
		NULL, NULL, NULL
	},

	/* Added by Rajmohan on 28/06/2014 */
	{
		{"show_actual_cost", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Set flag for showing actual cost in explain"),
			NULL
		},
		&show_actual_cost,
		DEFAULT_SHOW_ACTUAL_COST, DEFAULT_SHOW_ACTUAL_COST, INT_MAX,
		NULL, NULL, NULL
	},
	/* End-of-list marker */
	{
...
static struct config_real ConfigureNamesReal[] =
{
	...
	/* Added by Rajmohan on 28/06/2014 */
	{
		{"cost_limit", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Set the cost-limit for cost-limited execution"),
			NULL
		},
		&cost_limit,
		DEFAULT_COST_LIMIT, DEFAULT_COST_LIMIT, DBL_MAX,
		NULL, NULL, NULL
	},

	/* Added by Rajmohan on 28/06/2014 */
	{
		{"time_limit", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Set the time-limit for time bounded execution"),
			NULL
		},
		&time_limit,
		DEFAULT_TIME_LIMIT, DEFAULT_TIME_LIMIT, DBL_MAX,
		NULL, NULL, NULL
	},
