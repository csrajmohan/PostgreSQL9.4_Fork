...
ExecLimit(LimitState *node, double *outside_window_cost)  // rajmohan quest
{
...
//					check_query_cost;
				...
				/* <Added on 12/05/2015 for QUEST> */
				(*outside_window_cost) += outerPlan->total_cost - temp_total_cost;
				temp_total_cost = outerPlan->total_cost;
