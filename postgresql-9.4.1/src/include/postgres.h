...
/* ---------------------------------------------------------------------------
 * 			Section 4: QUEST handling support added by Rajmohan on 28/06/2014
 * ---------------------------------------------------------------------------
 */

/* Enable/disable partial execution */
#define PARTIAL_EXEC

/* Enable - Time Limited Execution Disable - Cost Limited Execution */
#define TIME_LIMITED_EXEC

#define DEFAULT_COST_LIMIT 								-1.0
#define DEFAULT_SPILL_NODE 								-1
#define DEFAULT_SHOW_ACTUAL_COST 						1
#define DEFAULT_TIME_LIMIT 								-1.0
#define increase_counter_by_one(c)						((c)++)

/* Global counter variables */
unsigned int pages_read;
unsigned int index_pages_read;
double total_pages_read;

unsigned int pages_written;

int spill_node;

int show_actual_cost;

/* These vars are declared and initialized in postgres.c */
extern PGDLLIMPORT double cost_limit;
extern PGDLLIMPORT double time_limit;

/* enable / disable CODD here */
#define CODD_ENABLED
//#undef CODD_ENABLED

//#define SELECTIVITY_DEBUG
