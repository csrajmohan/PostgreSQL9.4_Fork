...
typedef struct PlanState
{
	...
	Cost startup_cost;
	Cost total_cost;				/* Added by Rajmohan on 28/06/2014 for QUEST */
	Cost prev_total_cost;			/* Added by Rajmohan on 28/06/2014 for QUEST */
...
/* Added by Rajmohan on 28/06/2014 for QUEST */
#define IncreaseTupleCount(node, tuples) \
	do { \
		if (((PlanState *)(node))->instrument) \
			((PlanState *)(node))->instrument->totaltuples += (tuples); \
	} while(0)
#endif   /* EXECNODES_H */
